...
export default async function ReportsPage() {
  ...
  return (
    <DashboardShell profile={profileResult.data}>
      <div className="mb-6"><h1 className="text-3xl font-bold">Reports</h1><p className="mt-1 text-sm text-muted-foreground">Weekly and monthly summaries with AI budget conclusions and email preview.</p></div>
