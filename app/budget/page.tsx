...
export default async function BudgetPage() {
  ...
  const [profileResult, accountsResult, budgetsResult, transactionsResult, subscriptionsResult, equityResult] = await Promise.all([
  ...
  return (
    <DashboardShell profile={profileResult.data}>
      ...
      <div className="grid gap-6 xl:grid-cols-[1fr_360px]">
        <BudgetManager budgets={budgetsResult.data ?? []} transactions={transactions} />
